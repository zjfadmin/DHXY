 ...
 * 
 */
public class ImportantgoodtrcordServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ImportantgoodtrcordServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ImportantgoodssumrecordBean> selectImportantgoodsrecordList = AllServiceUtil.getImportantgoodtrcordService().selectImportantgoodsrecordList(time, weekendsum, Integer.parseInt(page));
		List<ImportantgoodsrecordBean> beans = new ArrayList<>();
		for (int i = 0; i < selectImportantgoodsrecordList.size(); i++) {
			ImportantgoodssumrecordBean entity = selectImportantgoodsrecordList.get(i);
			boolean is = true;
