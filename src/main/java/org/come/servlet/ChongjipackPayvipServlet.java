...
public class ChongjipackPayvipServlet extends HttpServlet{
	 ...
	 */
	public ChongjipackPayvipServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(page!=null){
			...
			List<ChongjipackBean> chongjipackBeanList =AllServiceUtil.getChongjipackServeice().selectChongjipack(Integer.valueOf(type),value);
